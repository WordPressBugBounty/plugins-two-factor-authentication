...
<div class="wrap">
	...
	<h2><?php echo esc_html__('Two Factor Authentication', 'two-factor-authentication') . ' ' . esc_html__('Settings', 'two-factor-authentication'); ?></h2>

	<?php

		if (!empty($totp_controller->were_settings_saved())) {
			echo '<div class="updated notice is-dismissible">' . "<p><strong>" . esc_html__('Settings saved.', 'two-factor-authentication') . "</strong></p></div>";
		}
